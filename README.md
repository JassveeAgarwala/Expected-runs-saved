...
**Counterfactual Reasoning with Logistic Regression**

The API uses a counterfactual framework to answer: *"What would have happened if a different fielder was in this position?"*
